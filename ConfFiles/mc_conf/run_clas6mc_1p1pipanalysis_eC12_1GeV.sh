...
declare -a OutputFiles=(
    "e4nuanalysis_1p1pip_GEM21_11a_Rarita_LFG_Q2_01_1GeV_eCarbon_NoRad"
    "e4nuanalysis_1p1pip_GEM21_11a_Rarita_LFG_Q2_01_1GeV_eCarbon_NoRad_NoFSI"
...
declare -a OutputFilesRadiated=("e4nuanalysis_1p1pip_GEM21_11a_Rarita_LFG_Q2_01_1GeV_eCarbon_Rad")
...
./e4nuanalysis --conf-file ${conf_file} --root-file ${path_mc_files}${RadiatedFiles[0]} --output-file ${path_output}${OutputFilesRadiated[0]} --analysis-type ComputeTrueAccCorr --xsec-file ${path_xsec}${XSecFiles[0]} --rad-corr truereco
