...
declare -a OutputFiles=("e4nuanalysis_1p1pip_G18_10a_Dipole_LFG_Q2_01_1GeV_eCarbon_NoRad"
...
./e4nuanalysis --conf-file ${conf_file} --root-file ${path_mc_files}${RadiatedFiles[0]} --output-file ${path_output}"e4nuanalysis_1p1pip_GEM21_11a_Dipole_LFG_Q2_01_1GeV_eCarbon_Rad" --analysis-type ComputeTrueAccCorr --xsec-file ${path_xsec}${XSecFiles[0]} --rad-corr true
