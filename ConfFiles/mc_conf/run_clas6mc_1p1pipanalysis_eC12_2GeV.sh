...
declare -a InputFiles=("G18_10a_Dipole_CFG_Q2_04_2GeV_eCarbon.gst.root"
...
declare -a OutputFiles=("e4nuanalysis_1p1pip_G18_10a_Dipole_CFG_Q2_04_2GeV_eCarbon_NoRad"
    "e4nuanalysis_1p1pip_G18_10a_Rarita_LFG_Q2_04_2GeV_eCarbon_NoRad"
    "e4nuanalysis_1p1pip_GEM21_11a_Dipole_CFG_Q2_04_2GeV_eCarbon_NoRad"
    "e4nuanalysis_1p1pip_GEM21_11a_Dipole_LFG_NoFSI_Q2_04_2GeV_eCarbon_NoRad"
    "e4nuanalysis_1p1pip_GEM21_11a_Dipole_LFG_Q2_04_2GeV_eCarbon_NoRad"
    "e4nuanalysis_1p1pip_GEM21_11a_Dipole_RFG_Q2_04_2GeV_eCarbon_NoRad"
    "e4nuanalysis_1p1pip_GEM21_11b_Dipole_LFG_Q2_04_2GeV_eCarbon_NoRad"
    "e4nuanalysis_1p1pip_GEM21_11c_Dipole_LFG_Q2_04_2GeV_eCarbon_NoRad"
    "e4nuanalysis_1p1pip_GEM21_11d_Dipole_LFG_Q2_04_2GeV_eCarbon_NoRad"
)
...
declare -a RadiatedFiles=("GEM21_11a_Dipole_LFG_Q2_04_2GeV_eCarbon_radiated.gst.root")
...
./e4nuanalysis --conf-file ${conf_file} --root-file ${path_mc_files}${RadiatedFiles[0]} --output-file ${path_output}"e4nuanalysis_1p1pip_GEM21_11a_Dipole_LFG_Q2_04_2GeV_eCarbon_Rad" --analysis-type ComputeTrueAccCorr --xsec-file ${path_xsec}${XSecFiles[0]} --rad-corr true
