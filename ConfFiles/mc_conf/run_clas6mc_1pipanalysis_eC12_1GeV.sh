...
declare -a OutputFiles=("/pnfs/genie/persistent/users/jtenavid/e4nu_files/AnalisedFiles/1pip/e4nuanalysis_1pipanalysis_G18_10a_Q2_01_e_on_1000060120_1161MeV_NoRad"
                        "/pnfs/genie/persistent/users/jtenavid/e4nu_files/AnalisedFiles/1pip/e4nuanalysis_1pipanalysis_G18_10b_Q2_01_e_on_1000060120_1161MeV_NoRad"
                        "/pnfs/genie/persistent/users/jtenavid/e4nu_files/AnalisedFiles/1pip/e4nuanalysis_1pipanalysis_G18_10a_NoFSI_Q2_01_e_on_1000060120_1161MeV_NoRad")
#                        "/pnfs/genie/persistent/users/jtenavid/e4nu_files/AnalisedFiles/1pip/e4nuanalysis_1pipanalysis_GEM21_11a_Q2_01_e_on_1000060120_1161MeV_NoRad"
#                        "/pnfs/genie/persistent/users/jtenavid/e4nu_files/AnalisedFiles/1pip/e4nuanalysis_1pipanalysis_G18_10a_Q2_01_Afros_e_on_1000060120_1161MeV_NoRad"
#                        "/pnfs/genie/persistent/users/jtenavid/e4nu_files/AnalisedFiles/1pip/e4nuanalysis_1pipanalysis_GEM21_11a_Q2_01_Afros_e_on_1000060120_1161MeV_NoRad")
...
do
    ./e4nuanalysis --conf-file ConfFiles/mc_conf/clas6mc_1pipanalysis_eC12_1GeV.txt --root-file ${InputFiles[$i]} --output-file ${OutputFiles[$i]} --analysis-type ComputeTrueAccCorr --xsec-file ${XSecFiles[$i]}
    ./e4nuanalysis --conf-file ConfFiles/mc_conf/clas6mc_1pipanalysis_eC12_1GeV.txt --root-file ${InputFiles[$i]} --output-file ${OutputFiles[$i]} --analysis-type ComputeTrueRecoAccCorr --xsec-file ${XSecFiles[$i]}
done
