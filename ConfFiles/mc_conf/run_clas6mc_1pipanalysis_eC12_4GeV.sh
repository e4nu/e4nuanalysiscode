...
declare -a OutputFiles=(
    ...
    "e4nuanalysis_1pip_GEM21_11a_Rarita_LFG_Q2_08_4GeV_eCarbon_NoRad_NoFSI"
...
declare -a OutputFilesRadiated=("e4nuanalysis_1pip_GEM21_11a_Rarita_LFG_Q2_01_1GeV_eCarbon_Rad")
