...
//2.2 GeV parameters
  ...
  //sector 3 has 2 gaps
   ...
   //2 and 4 GeV pi- fiducial parameters (the pol3 theta gaps, with a sensible variable name)
   //sector 5 has 2 gaps
   const Double_t fid_2gev_2250_pimifid_S5[2][2][4]={{{99.9404, 24.7386, -5.60018, 0.431221}, {119.312, 13.4537, -2.63984, 0.190205}},
						     {{97.5935, 4.44785, -0.611382, 0.0758808},{103.94, 1.76833, 0.32453, -0.00709944}}};

  //sector 3 has 2 gaps
   const Double_t fid_2gev_2250_pimifid_S3[2][2][4]={{{112.584, -8.50953 ,3.65541 ,-0.321358}, { 99.7915 ,11.1871 ,-1.96114 ,0.167723}},
						     {{37.6064, 7.00954, -0.489086, 0.0444082}, {41.3276, 4.96432, 0.660286, -0.0701486} }};

   //sector 1 has 2 gaps
   const Double_t fid_2gev_2250_pimifid_S1[2][2][4]={{{113.956, 0.363286, 0.198558 ,-0.0144791},
                { 124.963 ,-1.25147 ,0.390258, -0.0194753}},
                {{ 124.435, 2.93323, -0.655971, 0.0667888},{ 135.614 ,-2.55523 ,0.881528 , -0.0632905}}};

   //sector 4 has 1 gap
   const Double_t fid_2gev_2250_pimifid_S4[2][4]={{99.1183 ,3.87431 ,-0.651923, 0.0541116},
                {114.798, -1.74102, 0.670956, -0.0506822}};
