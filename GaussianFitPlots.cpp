...
//								TF1* f2 = new TF1("f2","gaus",0.5,0.92);
//								Plots[WhichFSIModel]->Fit("f2","","",0.5,0.92);
...
//								f2->Draw("same");								
								...
								TF1* f1 = new TF1("f1","gaus",1.12,1.3);
								Plots[WhichFSIModel]->Fit("f1","","",1.12,1.3);
...
//						legGenieBreak->Draw();
					...
					if ( 
						...
						{ 
						legGenie->SetTextSize(TextSize-0.04);
						//legGenie->Draw(); 
						}
