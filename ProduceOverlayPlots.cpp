...
//gROOT->ProcessLine(".L OverlayGenieV2VsV3.cpp"); gROOT->ProcessLine("OverlayGenieV2VsV3()");

//gROOT->ProcessLine(".L OverlayTestECalV2vsV3_e4nuPaper.cpp"); gROOT->ProcessLine("OverlayTestECalV2vsV3_e4nuPaper()");
