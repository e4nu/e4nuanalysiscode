...
//	}
	...
	int Q2Step = (maxQ2 - minQ2) / Q2Slices;
			...
			if(num_pi_phot==0 && N_prot_both!=0){
				...
				for(int f = 0; f < num_p; f++){    //looping through two protons
					...
					if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10 && Q2Slice > 0 && Q2Slice < 10) {
						...
						h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(E_tot_2p[f],LocalWeight);
					}
			...
			if (num_pi_phot==1) {
				...
				for(int z=0; z < N_2prot; z++){ //looping over two protons
					...
					if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10 && Q2Slice > 0 && Q2Slice < 10 ) {
						...
						h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(Ecal_2p1pi_to2p0pi[z],LocalWeight);
					}
					...
					if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10 && Q2Slice > 0 && Q2Slice < 10) {
						...
						h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(E_tot_2p[z],LocalWeight);			
					}
			...
			if(num_pi_phot==0 && N_p_three!=0){
				...
				for(int count = 0; count < N_comb; count++) { //Loop over number of combinations
					...
					for(int j = 0; j < N_2p; j++) { //loop over two protons
						...
						if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10 && Q2Slice > 0 && Q2Slice < 10) {
							...
							h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(E_cal_3pto2p[count][j],LocalWeight);
						}
				...
				for(int j = 0; j < N_3p; j++)    {
					...
					if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10 && Q2Slice > 0 && Q2Slice < 10 ) {
						...
						h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(E_cal[j],LocalWeight);
					}
					...
					if( N_p_three!=0 && N_p_four!=0){
						...
						for(int count = 0; count < N_comb; count++)    { //looping through number of 2 proton combination out of 3 protons
							...
							for(int j = 0;j < N_2p; j++)    {  //looping through number of 1 proton combination out of 2 protons
								...
								h1_EQE->Fill(E_rec,-P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*histoweight);
								...
								if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10 && Q2Slice > 0 && Q2Slice < 10) {
									...
									h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(E_cal_4pto3p[count][j],LocalWeight);
								}
						...
						for(int j = 0; j < N_3p; j++) { //4p to 3p->1, looping through 1p out of 3p
							...
							if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10&& Q2Slice > 0 && Q2Slice < 10) {
								...
								h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(E_cal_43pto1p[j],LocalWeight);
							}
						...
						if(ind1!=ind2 && ind1 < ind2){
							...
							if( N_two!=0  && N_p_four!=0){
								...
								for(int j = 0; j < N_2p; j++)  {  //looping through  1 proton combination out of 2 protons
									...
									h1_EQE->Fill(E_rec,P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*histoweight);
									...
									if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10 && Q2Slice > 0 && Q2Slice < 10) {
										...
										h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(E_cal_4pto2p[j],LocalWeight);		
									}
				...
				if( N_p_four!=0){
					...
					for(int j = 0; j < N_p4; j++)    {       //estimating the undetected 4p contribution to  1p
						...
						if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10 && Q2Slice > 0 && Q2Slice < 10) {
							...
							h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(E_cal_p4[j],LocalWeight);	
						}
		...
		if( num_p == 1) {
			...
			if(num_pi_phot == 0){
				...
				if (ThetaSlice > 0 && ThetaSlice < 10 && EePrimeSlice > 0 && EePrimeSlice < 10 && Q2Slice > 0 && Q2Slice < 10) {
					...
					h1_ECal_InEePrimeAndThetaSlices[EePrimeSlice][ThetaSlice]->Fill(E_tot,LocalWeight);				
				}
