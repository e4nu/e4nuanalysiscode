...
std::vector<double> plotting::GetBinning(std::string observable, double EBeam, std::string analysis_key)
{
  ...
  {
    if (EBeam == 1.161)
    binning = plotting::GetUniformBinning(25, 0.3, 1.1);
    else if (EBeam == 2.261)
    binning = plotting::GetUniformBinning(25, 0.3, 2);
    else if (EBeam == 4.461)
    binning = plotting::GetUniformBinning(25, 0.3, 3);
  }
  else if (observable == "proton_theta")
  {
    if (EBeam == 1.161)
    binning = plotting::GetUniformBinning(25, 12, 110);
    else if (EBeam == 2.261)
    binning = plotting::GetUniformBinning(25, 12, 110);
    else if (EBeam == 4.461)
    binning = plotting::GetUniformBinning(25, 12, 110);
  ...
  {
    if (EBeam == 1.161)
    binning = plotting::GetUniformBinning(25, 12, 180);
    else if (EBeam == 2.261)
    binning = plotting::GetUniformBinning(25, 12, 180);
    else if (EBeam == 4.461)
    binning = plotting::GetUniformBinning(25, 12, 180);
  ...
  {
    if (EBeam == 1.161)
    binning = plotting::GetUniformBinning(25, 0.3, 0.8);
    else if (EBeam == 2.261)
  ...
  else if (observable == "HadSystemMass")
  {
    ...
    binning = plotting::GetUniformBinning(25, 0, 2.7);
  }
  else if (observable == "MissingEnergy")
  {
    if (EBeam == 1.161)
  ...
  if (analysis_key == "1p1pip")
  {
    if (observable == "ECal")
    {
      if (EBeam == 1.161) binning = plotting::GetECalBinning(8, 8, 0.8, EBeam + 0.2, EBeam);
    ...
    {
      if (EBeam == 1.161) binning = plotting::GetUniformBinning(25, 0.2, 0.6);
      else if (EBeam == 2.261) binning = plotting::GetUniformBinning(25, 0.3, 1.2);
      else if (EBeam == 4.461) binning = plotting::GetUniformBinning(25, 0.3, 2.2);
    }
    else if (observable == "pip_theta")
    {
      if (EBeam == 1.161)
      binning = plotting::GetUniformBinning(25, 12, 120);
      else if (EBeam == 2.261)
    ...
    {
      if (EBeam == 1.161)
      binning = plotting::GetUniformBinning(25, 35, 180);
      else if (EBeam == 2.261)
      binning = plotting::GetUniformBinning(25, 35, 180);
      else if (EBeam == 4.461)
