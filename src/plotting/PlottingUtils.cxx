...
std::string plotting::GetAxisLabel( std::string observable, unsigned int id_axis ){
  ...
  else if ( observable == "RecoEvPion") { x_axis = "E_{rec} [GeV]"; y_axis = "d#sigma/dE_{rec} #left[#mub GeV^{-1}#right#right]"; }
  else if ( observable == "RecoWPion") { x_axis = "W_{rec} [GeV]"; y_axis = "d#sigma/dW_{rec} #left[#mub GeV^{-1}#right#right]"; }
...
std::vector<double> plotting::GetBinning( std::string observable, double EBeam, std::string analysis_key ){
  ...
  if( observable == "ECal") {
    ...
    if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 35, 20, 45 );
    else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 35, 20, 45 );
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 35, 15, 45 );
  } else if ( observable == "pfl_phi") {
    if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 35, 0, 180 );
    else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 35, 0, 180 );
    ...
    if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 30, 0.3, 1.1 );
    else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 30, 0.3, 2 );
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 30, 0.3, 3 );
  } else if ( observable == "proton_theta") {
    if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 35, 12, 110 );
    else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 35, 12, 110 );
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 35, 12, 110 );
    ...
    else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 35, 12, 140 );
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 35, 12, 140 );
  } else if ( observable == "pip_mom") {
    if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 35, 0.15, 3);
    else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 35, 0.15, 3 );
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 35, 0.15, 3 );
    ...
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 35, 12, 180 );
  } else if ( observable == "RecoW") {
    if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 35, 1, 1.5 );
    else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 35, 1, 1.9 );
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 35, 1.2, 2.5 );
    ...
    if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 35, 0, 1);
    else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 35, 0, 1 );
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 35, 0, 1 );
    ...
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 30, 0, 180 );
    ...
    else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 35, 15, 180 );
  ...
  if( analysis_key == "1p1pim" ) return binning ;
    ...
    if( observable == "ECal") {
      ...
      if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 25, 0.3, 1 );
      else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 30, 0.3, 2 );
      else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 30, 0.3, 3 );
    } else if ( observable == "pip_mom") {
      ...
      if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 20, 12, 120 );
      else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 25, 12, 130 );
      else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 30, 12, 130 );
    } else if ( observable == "HadDeltaPT" || observable == "DeltaPT" ) {
      ...
      if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 20, 35, 180 );
      else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 20, 35, 180 );
      else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 10, 35, 180 );
    } else if ( observable == "MissingMomentum"){
      if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 25, 0, 1 );
      ...
      if( EBeam == 1.161 ) binning = plotting::GetUniformBinning( 25, 1.1, 1.45 );
      else if( EBeam == 2.261 ) binning = plotting::GetUniformBinning( 35, 1, 1.9 );
      else if( EBeam == 4.461 ) binning = plotting::GetUniformBinning( 35, 1.2, 2.3 );    
    }
    ...
    if( observable == "ECal") {
      ...
      std::cout << binning.size() << std::endl;
    }
