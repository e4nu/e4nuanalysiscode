...
//TString FSIModel = "hA";
//TString FSIModel = "hA2014";
//TString FSIModel = "hA2015";
//TString FSIModel = "hN";
//TString FSIModel = "hN2014";
//TString FSIModel = "hN2015";

//TString FSIModel = "hA2018"; 
//TString FSIModel = "hN2018"; 
TString FSIModel = "hA2018_LFG"; 

//TString WhichSample = "default";

//TString WhichSample = "rad";
//TString WhichSample = "radSIMCcutoffMeV";
//TString WhichSample = "simpleMax20Min25";
TString WhichSample = "EMradcorrLarryWeights";
//TString WhichSample = "norad";
//TString WhichSample = "radVanderhagenMinE20";
//TString WhichSample = "radSIMCMinE20";
//TString WhichSample = "NoRadCorr";

//TString WhichSample = "NoRadCorr_CFGM";
//TString WhichSample = "RadCorr_CFGM";

TString graphstring = "";
//TString graphstring = "graphcut";

TString file_name = "./myFiles/"+E+"/"+FSIModel+"_"+WhichSample+"/"+Target+"_"+E+"_"+FSIModel+"_"+WhichSample+graphstring+"_Plots"+FSI;

TString FullPath = "./mySamples";

//TString FullInputName = FullPath+"/"+"eresmaid_"+Target+"_"+E+"_"+FSIModel+FSI+"_"+WhichSample+".root";
TString FullInputName = "/pnfs/genie/persistent/users/adi/e4nu/e_p_EMQE_"+WhichSample+".gst.root"; 
...
// used to generate this class and read the Tree.
   if (tree == 0) {
	...
	TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(FullInputName);
	if (!f || !f->IsOpen()) f = new TFile(FullInputName);
