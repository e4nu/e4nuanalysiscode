...
namespace e4nu {
  ...
  struct Fiducial {
    ...
    Bool_t FiducialCut( const int pdg, const double beam_en, TVector3 momentum, const bool is_data ) ; 
    ...
    std::unique_ptr<TF1> myPiMinusFit;

    std::unique_ptr<TF1> up_lim1_ec, up_lim2_ec,up_lim3_ec,up_lim4_ec, up_lim5_ec,up_lim6_ec,low_lim1_ec,low_lim2_ec,low_lim3_ec, low_lim4_ec,low_lim5_ec,low_lim6_ec;
    std::unique_ptr<TF1> leftside_lim1_ec, leftside_lim2_ec,leftside_lim3_ec, leftside_lim4_ec,leftside_lim5_ec, leftside_lim6_ec,rightside_lim1_ec, rightside_lim2_ec,rightside_lim3_ec, rightside_lim4_ec,rightside_lim5_ec, rightside_lim6_ec;

    //4.4 GeV parameters
    //e- parameters
    float fgPar_4Gev_2250_Efid_t0_p[6][2];// 4GeV e- fiducial cut parameters
    float fgPar_4Gev_2250_Efid_t1_p[6][6];
    float fgPar_4Gev_2250_Efid_b_p[6][2][6];
    float fgPar_4Gev_2250_Efid_a_p[6][2][6];
    float fgPar_4Gev_2250_Efid_Theta_S5_extra[8][4];
    float fgPar_4Gev_2250_Efid_Theta_S4_extra[2][4];
    float fgPar_4Gev_2250_Efid_Theta_S3_extra[4][4];
    float fgPar_4Gev_2250_Efid_Theta_S5[8][8];
    float fgPar_4Gev_2250_Efid_Theta_S4[2][8];
    float fgPar_4Gev_2250_Efid_Theta_S3[4][8];
    //proton parameter
    float fgPar_4Gev_2250_Pfid_ScpdS2[2][6];
    float fgPar_4Gev_2250_Pfid_ScpdS3[8][6];
    float fgPar_4Gev_2250_Pfid_ScpdS4[4][6];
    float fgPar_4Gev_2250_Pfid_ScpdS5[8][6];
    float fgPar_4Gev_2250_Pfid_ScpdS2_extra[2][4];
    float fgPar_4Gev_2250_Pfid_ScpdS3_extra[8][4];
    float fgPar_4Gev_2250_Pfid_ScpdS4_extra[4][4];
    float fgPar_4Gev_2250_Pfid_ScpdS5_extra[8][4];
    float fgPar_4Gev_2250_Pfidft1l[6][6];
    float fgPar_4Gev_2250_Pfidft1r[6][6];
    float fgPar_4Gev_2250_Pfidft2l[6][6];
    float fgPar_4Gev_2250_Pfidft2r[6][6];
    float fgPar_4Gev_2250_Pfidbt1l[6][6];
    float fgPar_4Gev_2250_Pfidbt1r[6][6];
    float fgPar_4Gev_2250_Pfidbt2l[6][6];
    float fgPar_4Gev_2250_Pfidbt2r[6][6];
    float fgPar_4Gev_2250_Pfidbl[6][6];
    float fgPar_4Gev_2250_Pfidbr[6][6];
    ...
    // 750A Torus Current
    static constexpr double fgPar_1Gev_750[6][6][4] =
    ...
    // 1500A Torus Current
    static constexpr double fgPar_1Gev_1500[6][6][4]  =
    ...
    static constexpr double fid_1gev_750_efid_S5[3][2][4] = {{{111.088 , 7.4495 , -0.810668 , 0.0314985},
    ...
    //sector 4 has 2 gaps
    static constexpr double fid_1gev_750_efid_S4[2][2][4] = {{{30.5039 , 5.98362 , -12.825 , 7.04185},
						   {25.4698 , 13.3482 , -7.32756 ,1.61262}},
						  {{99.758,  1.35143  ,-0.115901,  0.0033244},
						   {111.575 , 0.00204503 , 0.122899 , -0.00687251}}};
    //sector 3 has 4 gaps
    static constexpr double fid_1gev_750_efid_S3[4][2][4] = {{{17.1438 , 5.82672 , -1.33914 , 0.370319},
    ...
    /*    double fid_1gev_750_efid_S3[4][2][4] = {{{17.1438 , 5.82672 , -1.33914 , 0.370319}, */
    /*               {8.71859 , 23.4486 , -10.8172 , 1.97916}}, */
    ...
    /*               {{97.15,  1.94998 , 0 , 0},{109.858, 1.19822 ,0, 0}}}; */
    //sector 2 has 1 gap1
    static constexpr double fid_1gev_750_efid_S2[2][4] = {{19.6927, 8.30968, -2.7451, 0.457127},{24.816,  3.00121, 0 ,0}};

    //pi minus theta gap parameters
    static constexpr double fid_1gev_750_pimifid_S5[2][2][4] = {{{111.088 , 7.4495 , -0.810668 , 0.0314985}, {119.088 , 7.4495  ,-0.810668 , 0.0314985}},
    ...
    //sector 4 has 2 gaps
    static constexpr double fid_1gev_750_pimifid_S4[2][2][4] = {{{35.8238, 6.86212, -0.686454, 0.0249186}, {38.5397, 8.72133, -1.18367, 0.0582613}},
						     {{99.758,  1.35143  ,-0.115901,  0.0033244}, {111.575 , 0.00204503 , 0.122899 , -0.00687251}}};
    //sector 3 has 4 gaps
    static constexpr double fid_1gev_750_pimifid_S3[3][2][4] = {//{{17.1438 , 5.82672 , -1.33914 , 0.370319},  {8.71859 , 23.4486 , -10.8172 , 1.97916}},
      ...
      {{97.15,  1.94998 , 0 , 0},{109.858, 1.19822 ,0, 0}}};
    //sector 2 has 1 gap1
    static constexpr double fid_1gev_750_pimifid_S2[2][4] = {{19.6927, 8.30968, -2.7451, 0.457127},{24.816,  3.00121, 0 ,0}};

    //sector 1 has 1 gap
    static constexpr double fid_1gev_750_pimifid_S1[2][4] = {{113.259, 10.763, -2.45037, 0.201482},{135.89, 1.31017, -0.27533, 0.0355386}};


    //1GeV p and pi+ fiducial parameters (theta gaps)
    //sector 1 has 2 gaps
    static constexpr double fid_1gev_750_pfid_S1[2][2][4]={{{120.448, 1.10613 ,-0.794723, 0.0656712},{147.559, -11.4625 ,2.2709 ,-0.158945}},
						{{67.1972 ,-25.2405, 7.16785, -0.748601},{50.2896, -0.809075, -1.79123, 0.334088}}};
    //sector 2 has 1 gap1
    static constexpr double fid_1gev_750_pfid_S2[2][4]={{47.7655 , -4.02984 , 0  ,0 },{49.2938 , -2.62524 , 0 , 0}};
    ...
    static constexpr double fid_1gev_750_pfid_S3[4][2][4]={{{ 118.212,  -2.17485 , 0.0211904 , 0.00847772},{137.918 , -11.0922 , 2.63701 , -0.227367}},
    ...
    //sector 4 has 2 gaps
    static constexpr double fid_1gev_750_pfid_S4[2][2][4]={{{104.013 , -0.902977 , 0 , 0},{110.284 , -0.663729,  0 , 0}},
    ...
    static constexpr double fid_1gev_750_pfid_S5[4][2][4]={{{122.754 , -1.38182,  0 , 0 },{150.113 , -15.231 , 3.59444 , -0.294359}},
    ...
    //sector 1 has 2 gaps
    static constexpr double fid_1gev_750_pfid_S6[2][2][4]={{{64.3241,-25.288  ,8.33577 ,-1.01602},{ 37.2644, 10.6393 ,-4.63834 ,0.507171}},
						{{45.6131, 7.2492, -1.9949, 0.200048},{57.2786, 1.79723, -0.506705, 0.117659}}};

    //2.2 GeV parameters
    static constexpr  float fgPar_2GeV_2250_Efid[6][6][9] = {{
    ...
    static constexpr  float fgPar_2GeV_2250_EfidTheta_S3[4][8] = {{74.4893, -158.720, 251.241, -200.000, 52.2984, 25.4188, -18.8692, 3.27217},
    ...
    static constexpr  float fgPar_2GeV_2250_EfidTheta_S4[2][8] = {{77.7940, -192.492, 361.852, -394.127, 246.499, -84.6133, 13.9182, -0.713846},
						       {41.2902, 110.603, -586.690, 1130.70, -1137.27, 633.345, -185.038, 22.1482}};

    static constexpr  float fgPar_2GeV_2250_EfidTheta_S5[8][8] = {{-12998.3, 57694.0, -109085, 114102, -71303.6, 26616.9, -5494.45, 483.756},
    ...
    static constexpr  float fgPar_2GeV_2250_Pfid_For[6][4][7] =  {{{60.2165, -189.720, 446.990, -523.122, 320.721, -97.8518, 11.5258},
    ...
    static constexpr  float fgPar_2GeV_2250_Pfid_Bak[6][4][7] = {{{110.007, 121.302, 97.8380, -1679.71, 4022.73, -3973.09, 1422.42},
    ...
    //sector 2
    static constexpr  float fgPar_2GeV_2250_Pfid_ScpdS2[2][6] = {{-28.1486, 425.124, -935.693, 1065.39, -608.526, 137.658},
						      {-15.2084, 345.466, -697.657, 751.738, -419.288, 95.2206}};

    //sector 3
    static constexpr  float fgPar_2GeV_2250_Pfid_ScpdS3[8][6] = {{17.1490, 294.605, -640.590, 707.758, -386.730, 83.2529},
 ...
 //sector 4
  ...
  //   static constexpr float fgPar_2GeV_2250_Pfid_ScpdS4[4][6] = {{81.8115, 139.810, -445.130, 804.212, -821.194, 364.924},
  ...
  static constexpr float fgPar_2GeV_2250_Pfid_ScpdS4[4][6] = {{94.5916, 18.0014, 18.3364, -41.7853, -80.3446, 116.192},
						     {101.77, 13.705, 20.2075, -33.6107, -70.4325, 100.421},  
						     {-137.480, 633.288, -954.383, 721.057, -269.140, 39.4822},
						     {-145.605, 697.662, -1088.74, 853.855, -330.883, 50.3421}};

    //sector 5
  //static constexpr float fgPar_2GeV_2250_Pfid_ScpdS5[8][6] = {{-29.9426, 370.963, -714.697, 707.343, -348.995, 67.7647},
  ...
  //modified gap parameters, May 2023
   static constexpr float fgPar_2GeV_2250_Pfid_ScpdS5[8][6] = {{-29.9426, 370.963, -714.697, 707.343, -348.995, 67.7647},
    ...
    //
    double fid_2gev_2250_pimifid_outline[6][6][5]={ { {437.992 , -6758.33 , 44725 , -130667 , 140000},
    ...
    //sector 5 has 2 gaps
    static constexpr double fid_2gev_2250_efid_S5[2][2][4]={{{88.912, 39.7076 ,-11.7886, 1.219},
						  {102.112 ,37.1564 ,-12.6383 ,1.49529}},
						 {{100.903 ,-0.978802 ,1.99633 ,-0.285675},{103.959, 2.03364, -0.0566607 ,0.11236}}};

    //sector 3 has 2 gaps
    static constexpr double fid_2gev_2250_efid_S3[2][2][4]={{{112.584, -8.50953 ,3.65541 ,-0.321358},
						  { 99.7915 ,11.1871 ,-1.96114 ,0.167723}},
						 {{15.4065, 35.6826 ,-11.4842 ,1.35174},{-8.2081, 44.1171 ,-9.23191 ,0.696626}}};

    //sector 1 has 2 gaps
    static constexpr double fid_2gev_2250_efid_S1[2][2][4]={{{113.956, 0.363286, 0.198558 ,-0.0144791},
						  { 124.963 ,-1.25147 ,0.390258, -0.0194753}},
						 {{ 172.863 ,-31.0937 ,6.70311, -0.4403},{ 135.614 ,-2.55523 ,0.881528 , -0.0632905}}};

    //sector 4 has 1 gap
    static constexpr double fid_2gev_2250_efid_S4[2][4]={{99.1183 ,3.87431 ,-0.651923, 0.0541116},
					      {114.798, -1.74102, 0.670956, -0.0506822}};

    //sector 6 has 1 gap
    static constexpr double fid_2gev_2250_efid_S6[2][4]={{80.5638, -15.6315 ,3.64252 ,-0.267854},
    ...
    //sector 1 has 2 gaps
    static constexpr double fid_2gev_2250_pimifid_S1[2][2][4]={{{113.956, 0.363286, 0.198558 ,-0.0144791}, {124.963, -1.25147, 0.390258, -0.0194753}},
						    {{124.435, 2.93323, -0.655971, 0.0667888}, {135.614, -2.55523, 0.881528, -0.0632905}}};
  
    //sector 2 currently has no gaps
    // static constexpr double fid_2gev_2250_pimifid_S2

    //sector 3 has 3 gaps
    static constexpr double fid_2gev_2250_pimifid_S3[3][2][4]={{{112.584, -8.50953 ,3.65541 ,-0.321358}, { 99.7915 ,11.1871 ,-1.96114 ,0.167723}},
    ...
    //sector 4 has 2 gaps
    static constexpr double fid_2gev_2250_pimifid_S4[2][2][4]={{{99.1183 ,3.87431 ,-0.651923, 0.0541116}, {114.798, -1.74102, 0.670956, -0.0506822}},
						    {{17.4548, 12.0517, -1.60906, 0.108019}, {20.2729, 8.8091, -0.0491563, -0.0567015}}};
  
    //sector 5 has 4 gaps
    static constexpr double fid_2gev_2250_pimifid_S5[4][2][4]={{{99.9404, 24.7386, -5.60018, 0.431221}, {119.312, 13.4537, -2.63984, 0.190205}},
    ...
    //sector 6 has 1 gap
    static constexpr double fid_2gev_2250_pimifid_S6[2][4]={{80.5638, -15.6315 ,3.64252 ,-0.267854},
						 { 51.8427, 10.8915,-2.38221, 0.177976}};
  
    //The momentum dependent theta upper limits for pi- at 4GeV and all particles at 1GeV
    static constexpr float pimi_thetamax2and4[5]={148.8 , 64.7164 , -234.766 , 140.342 , -25.4952};
    static constexpr float pimi_thetamax1[5]={180.316 , -510.125 , 2592.66 , -5389.62 , 3393.97};
    static constexpr float pipl_thetamax1[5]={143.52 , -114.506 , 409.901 , -461.16 , 97.7215};
    static constexpr float el_thetamax1[5]={105.51 , -262.424 , 469.016 , -365.019 , 102.453};
