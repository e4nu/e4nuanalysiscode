...
namespace e4nu
{
  namespace utils
  {
    ...
    double GetRecoEvPionProduction(const double EBeam, const TLorentzVector out_electron, const TLorentzVector out_pion);
    double GetRecoWPionProduction(const double EBeam, const TLorentzVector out_electron, const TLorentzVector out_pion);
  }
}
