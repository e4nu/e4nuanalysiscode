...
namespace e4nu {
  namespace utils
  {
    ...
    double SIMCRadCorrQELRadInElectron( const double EBeam, const TLorentzVector electron, const int tgt, const double thickness, const double max_Ephoton );
    double SIMCRadCorrQELRadOutElectron( const TLorentzVector electron_vertex, TLorentzVector & out_electron, const double EBeam, const double Q2, const int tgt, const double thickness, const double max_Ephoton ) ;
